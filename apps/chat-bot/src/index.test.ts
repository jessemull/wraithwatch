...
>;
const mockGetWraithResponse = getWraithResponse as jest.MockedFunction<
  typeof getWraithResponse
>;
...
describe('Wraithwatch Chat Bot Handler', () => {
  ...
  beforeEach(() => {
    ...
    mockGetCorsHeaders.mockReturnValue({
      'Access-Control-Allow-Origin': 'https://wraithwatch-demo.com',
    ...
    mockGetWraithResponse.mockResolvedValue({
  ...
  it('should handle POST request with valid message', async () => {
    ...
    expect(mockGetWraithResponse).toHaveBeenCalledWith('Hello bot!', undefined);
  });
  ...
  it('should handle POST request with existing conversation history', async () => {
    ...
    expect(mockGetWraithResponse).toHaveBeenCalledWith(
      'Follow up question',
      existingHistory
    );
  });
  ...
  it('should handle general error in handler', async () => {
    mockGetWraithResponse.mockRejectedValue(new Error('Unexpected error'));
...
describe('Barrel Exports', () => {
  it('should export all constants', async () => {
    ...
    expect(WRAITHWATCH_SYSTEM_PROMPT).toBeDefined();
  });

  it('should export all services', async () => {
    const { getWraithResponse } = await import('./services');
    expect(getWraithResponse).toBeDefined();
  });
...
describe('CORS Utils', () => {
  it('should return correct CORS headers for allowed origin', () => {
    const headers = getCorsHeaders('https://wraithwatch-demo.com');
